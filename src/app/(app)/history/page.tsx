              ...
              <Card key={w.id} className={`overflow-hidden ${open ? "ring-2 ring-brand-200 dark:ring-brand-500/30" : ""}`}>
                <div className="flex justify-between items-start gap-3 p-5">
                  <button
                    ...
                    aria-expanded={open}
                  >
                    <h3 className="font-bold text-zinc-900 dark:text-white text-base truncate">{w.name}</h3>
                    <div className="text-xs text-zinc-500 flex items-center gap-1.5 mt-0.5">
                      ...
                      <span>·</span>
                      <span>{formatWeight(w.totalVolume, units, 0)}</span>
                    </div>
                  </button>
                  <div className="flex items-center gap-1 shrink-0">
                    <Link
                      ...
                      className="text-zinc-400 hover:text-brand-600 p-2 min-w-[44px] min-h-[44px] rounded-full hover:bg-brand-50 dark:hover:bg-brand-500/20 transition-colors flex items-center justify-center"
                    >
                    ...
                    <Confirm
                      ...
                      trigger={(openConfirm) => (
                        <button
                          ...
                          className="text-zinc-400 hover:text-red-500 p-2 min-w-[44px] min-h-[44px] rounded-full hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors flex items-center justify-center"
                          >
                    ...
                    <button
                      ...
                      className="text-zinc-400 hover:text-zinc-600 p-2 min-w-[44px] min-h-[44px] rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors flex items-center justify-center"
                    >
